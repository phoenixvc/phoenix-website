...
import { LAVENDER_ENVIRONMENT } from "./registry";

const meta = {
  title: "Themes/Lavender/Environment",
  component: ThemeEnvironment,
  parameters: { layout: "fullscreen" },
  decorators: [
    (Story): ReactElement => (
      <div style={{ minHeight: "100vh", background: "#120d1c" }}>
        <Story />
      </div>
    ),
  ],
...
export const DeterministicStaticFrame: Story = {
  args: { fixture: LAVENDER_ENVIRONMENT.staticFixture },
};

export const DeterministicLight: Story = {
  args: {
    isDarkMode: false,
    fixture: LAVENDER_ENVIRONMENT.staticFixture,
  },
};
