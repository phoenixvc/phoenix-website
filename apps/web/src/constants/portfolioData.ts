...
export const STATUS_CONFIG: Record<ProjectStatus, StatusConfig> = {
  ...
  "private-preview": {
    ...
    description: "Available to a limited group of invited users and partners",
  },
  "pre-alpha": {
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    speed: 0.000022,
    title: "Enterprise AI Transformation Framework (Private Preview)",
  ...
  // AI & Machine Learning Focus Area - CodeFlow AI
  {
    ...
    speed: 0.000021,
    title: "AI-Powered PR Automation Platform (Private Preview)",
    status: "private-preview",
  ...
  },
  {
    ...
    fullName: "Sluice",
    speed: 0.00002,
    title: "OpenAI-Compatible AI Gateway (Private Preview)",
    status: "private-preview",
  ...
  },
  {
    ...
    fullName: "Docket",
    speed: 0.000019,
    title: "LLM Cost Operations Platform (Private Preview)",
    status: "private-preview",
  ...
  },
  {
    ...
    fullName: "ConvoLens",
    speed: 0.000018,
    title: "Grounded Conversation Intelligence (Private Preview)",
    status: "private-preview",
    bio: "ConvoLens helps people catch up on long conversations, trace summaries and action items back to their sources, and turn reviewed follow-ups into personal work. WhatsApp is the current connected intake, while other channel experiences remain clearly labeled previews.",
    department: "AI Products",
    experience: 0,
    expertise: "NLP, Conversation Analytics, Summarization",
    projects: [
      "Source-Linked Catch-Up",
      "Personal Follow-Ups",
      "Conversation Insight",
    ],
    skills: ["AI", "NLP", "Grounded Analytics", "Summarization"],
    relatedProjects: ["mystira", "cognitivemesh", "baton"],
    product: "https://github.com/neuralliquid/convolens",
    focusArea: "ai-ml",
  },
  ...
  // Infrastructure (Supporting Projects)
  {
    ...
    fullName: "OmniPost",
    speed: 0.000017,
    title: "Multi-Channel Content Distribution (Private Preview)",
    status: "private-preview",
  ...
  {
    id: "house-of-veritas",
    name: "House of Veritas",
    initials: "HV",
    position: "Estate Operations",
    mass: 120,
    color: "#0ea5e9",
    tagline: "Governed estate operations and compliance workflows",
    fullName: "House of Veritas",
    speed: 0.000016,
    title: "Estate Operations Platform (Private Preview)",
    status: "private-preview",
    bio: "House of Veritas brings document management, approvals, e-signatures, payroll, compliance, and multi-persona estate workflows into one governed operating environment.",
    department: "Operations",
    experience: 0,
    expertise: "Estate Operations, Governance, Compliance",
    projects: ["Document Governance", "Estate Workflows", "Compliance"],
    skills: ["Operations", "Governance", "Compliance", "Workflows"],
    relatedProjects: ["baton", "cognitivemesh", "docket"],
    product: "https://github.com/neuralliquid/house-of-veritas",
    focusArea: "infrastructure",
  },
  {
    id: "baton",
    name: "Baton",
    initials: "BT",
    position: "Human-Agent Coordination",
    mass: 110,
    color: "#f59e0b",
    tagline: "Shared task graph for people and AI agents",
    fullName: "Baton",
    speed: 0.000018,
    title: "Human-Agent Coordination Platform (Private Preview)",
    status: "private-preview",
    bio: "Baton gives people and AI agents a shared, auditable task graph with a Kanban workspace, MCP integration, typed task relationships, and repository-aware coordination.",
    department: "Developer Tools",
    experience: 0,
    expertise: "Agent Coordination, Task Graphs, MCP",
